...
const welcome: ChatMessage = {
  ...
  role: 'assistant',
  text: 'ألصق دفعة المفاتيح مرة واحدة. سنصنف الصيغ المعروفة محلياً، ثم نتحقق من الموفّرات المعروفة فقط. يُفحص مفتاح GitHub كتطوير للمستودع وليس كمفتاح نموذج. لا تظهر القيم في النتيجة ولا تحفظ في السجل أو قاعدة البيانات.',
};
