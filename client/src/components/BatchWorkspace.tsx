...
function BatchItemCard({ item, sharedDetails, index, total, disabled, onMove, onRemove, onApplySuggestion, onDownload, onShare, onItemDetailsChange, onMarketingTextChange }: { item: BatchAdItem; sharedDetails: AdDetails; index: number; total: number; disabled: boolean; onMove: (direction: 'up' | 'down') => void; onRemove: () => void; onApplySuggestion: () => void; onDownload: () => void; onShare: () => void; onItemDetailsChange: (patch: NonNullable<BatchAdItem['details']>) => void; onMarketingTextChange: (text: string) => void }) {
