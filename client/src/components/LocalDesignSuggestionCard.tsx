...
export default function LocalDesignSuggestionCard({ suggestion, selectedSize, onSelectSize, onAccept, onIgnore, onUndo, accepted = false }: LocalDesignSuggestionCardProps) {
