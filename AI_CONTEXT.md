...
- **تفويض Try‑On الحالي:** يجوز إضافة مسار Virtual Try‑On اختياري ومحكوم بعد رفع القطعة، وفق `DEFERRED_TRYON_SCOPE_2026.md`. لا يرسل صورة قبل موافقة عربية صريحة، ولا يستنتج العمر أو الجنس من صورة، ولا يدخل النتيجة إلى Canvas إلا بعد اعتماد صريح. يستمر المسار المحلي عند غياب المزود أو المفتاح أو الشبكة أو عند الإلغاء أو الفشل، ولا يظهر أي سر في العميل أو Git أو الاختبارات.
